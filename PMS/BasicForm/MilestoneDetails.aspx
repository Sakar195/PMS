            ...
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="MILESTONE_ID" DataSourceID="SqlDataSource2" Width="46px">
                <InsertItemTemplate>
                    ...
                    <asp:TextBox ID="MILESTONE_DUE_DATETextBox" runat="server" Text='<%# Bind("MILESTONE_DUE_DATE") %>' />
                            <br />
                     Project: 
                    <asp:DropDownList ID ="ProjectDropDown" runat="server" DataSourceID="SqlDataSource4" DataTextField="PROJECT_NAME" DataValueField="PROJECT_NAME" SelectedValue='<%# Bind("P_ID") %>'></asp:DropDownList>
