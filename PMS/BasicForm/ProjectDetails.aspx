    ...
    <p>
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="PROJECT_ID" DataSourceID="SqlDataSource1">
            <InsertItemTemplate>
                ...
                <br />
                CATEGORY: 
 <asp:DropDownList ID="CategoryDropDown" runat="server" DataSourceID="SqlDataSource2" DataTextField="CATEGORY_NAME" DataValueField="CATEGORY_ID" SelectedValue='<%# Bind("CATEGORY_ID") %>'></asp:DropDownList>
